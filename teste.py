...
if __name__ == '__main__':
    ...
    dqnAgent = DQNAgent(
                        ...
                        architecture=arch,
                        callbacks=CheckpointCallback("experiments/dqn/", "dqn", 50000),
    ...
    doubledqnAgent = DoubleDQNAgent(
                        ...
                        grad_norm_clip=grad_norm_clip,
                        architecture=arch,
                        callbacks=CheckpointCallback("experiments/double/", "dqn", 50000),
    ...
    prioritizedDQNAgent = PrioritizedDQNAgent(
                        ...
                        grad_norm_clip=grad_norm_clip,
                        architecture=arch,
                        callbacks=CheckpointCallback("experiments/prioritized/", "dqn", 50000),
    ...
    duelingDQNAgent = DuelingDQNAgent(
                        ...
                        callbacks=CheckpointCallback("experiments/dueling/", "dqn", 50000),
    ...
    multistepDQNAgent = MultiStepDQNAgent(
                        ...
                        grad_norm_clip=grad_norm_clip,
                        architecture=arch,
                        callbacks=CheckpointCallback("experiments/multistep/", "dqn", 50000),
    ...
    noisyDQNAgent = NoisyNetDQNAgent(
                        ...
                        grad_norm_clip=grad_norm_clip,
                        architecture=arch,
                        callbacks=CheckpointCallback("experiments/noisy/", "dqn", 50000),
    ...
    distributionalDQNAgent = DistributionalDQNAgent(
                        ...
                        grad_norm_clip=grad_norm_clip,
                        architecture=arch,
                        callbacks=CheckpointCallback("experiments/distributional/", "dqn", 50000),
    ...
    rainbowAgent = RainbowAgent(
                        ...
                        grad_norm_clip=grad_norm_clip,
                        architecture=dueling_arch,
                        callbacks=CheckpointCallback("experiments/rainbow/", "rainbow", 50000),
